...
namespace discnet
{
    class route_manager
    {
        ...
        typedef std::map<adapter_guid_t, routes_t> adapter_routes_map_t;
    ...
    public:
        ...
        DISCNET_EXPORT routes_t find_routes_for_adapter(const adapter_guid_t& outbound_adapter);
        DISCNET_EXPORT routes_t find_routes_on_adapter(const adapter_guid_t& adapter);
    private:
